...
function ScheduleEdit() {
  ...
  const handleChange = async (
    ...
    await fetch(
      `${Server}/api/newSchedule/${localStorage.getItem("specIndex")}`,
      {
        method: "PATCH",
  ...
  const formedSchedule: (scheduleDayType | string)[][] = zip(
    ScheduleData,
    days
  );
  ...
  return <div className="scheduleedit--container">{schedule}</div>;
}
