...
function SideScheduleElement({
  ...
  let classname = "";
  if (index == 1) classname = "first";
  else if (index == 6) classname = "last";
      ...
      <div className="EditSchedule--class">
        <p className="class--type">
          <select
            ...
            // value={"cas"}
            onChange={(e) => handleChange(e, scheduleDay.id, "module")}
          >
            {Modluesoptions}
          </select>
        </p>
        <p>
          <select
            ...
            onChange={(e) => handleChange(e, scheduleDay.id, "type")}
          >
            {Typeoptions}
          </select>
        </p>
        <p className="class--type">
          <select
            ...
            onChange={(e) => handleChange(e, scheduleDay.id, "Classroom")}
          >
            {Classroomoptions}
          </select>
        </p>
